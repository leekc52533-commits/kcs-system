...
export function adoptTemporaryLocation(id,{adoptedBy='Supervisor',adoptedByAccountId=null,reason=''}={},database=defaultDb){
  ...
  if(official?.latitude!=null&&official?.longitude!=null)throw new Error('Official GPS already exists for this Branch. Withdraw it before approving another GPS.')
