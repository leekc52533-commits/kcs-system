...
export function listExpenseRecords(filters={},database=defaultDb){
  ...
  for(const item of items)item.correctionCount=correctionCounts.get(item.recordKey)||0
