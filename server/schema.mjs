import {salePriceSchema} from './migrationV80.mjs'
...
import {attendanceSchema} from './migrationV75.mjs'
import {flexibleCollectionSchema} from './migrationV74.mjs'
import {incomeNoticeSchema} from './migrationV73.mjs'
import {earningsSchema} from './migrationV72.mjs'
import {cargoBatchSchema} from './migrationV71.mjs'
...
import {menuSchemaSql} from './migrationV61.mjs'
import {salesSchemaSql} from './migrationV60.mjs'
...
CREATE TABLE IF NOT EXISTS daily_route_approvals (
  dispatch_day_id INTEGER NOT NULL REFERENCES dispatch_days(id) ON DELETE CASCADE,
  route_number INTEGER NOT NULL CHECK(route_number BETWEEN 1 AND 5),
