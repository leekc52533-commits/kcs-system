...
export default function CustomerReceipt({bill}){
 ...
 return <><button type="button" className="proof-view-link" onClick={e=>{e.stopPropagation();setOpen(true)}}>{l.view}</button>{open&&createPortal(<ReceiptDialog bill={bill} close={()=>setOpen(false)}/>,document.body)}</>
}
