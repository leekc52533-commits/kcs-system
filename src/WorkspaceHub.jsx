...
export function StaffAccountHub({currentUser,account}){return <ResourcePage embedded fixedTab initialTab="employees" currentUser={currentUser} account={account}/>}
