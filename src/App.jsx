...
const navigation=[['dashboard','⌂','nav.dashboard'],['operations','↗','nav.dispatchSchedule'],['customers','◎','nav.customers'],['buyers','◉','nav.buyers'],['location-zone','⌖','nav.locationGpsZone'],['vehicles','◇','nav.vehicles'],['materials','▦','nav.materials'],['staff','♙','nav.staffAccounts']]
