...
const resolvePage=(raw,tab='')=>{const mapped=legacyPages[raw],page=mapped?.[0]||raw,pageTab=tab||mapped?.[1]||'';return page==='customers'&&pageTab==='locations'?{page:'company-settings',tab:''}:page==='location-zone'&&pageTab==='area-zone'?{page:'operations',tab:'area-zone'}:page==='location-zone'?{page:'customers',tab:'settings'}:page==='operations'&&pageTab==='schedules'?{page:'customers',tab:'schedules'}:{page,tab:pageTab}}
