...
function DesktopApp({account,onLogout,onChangePassword}){
  ...
  const start=initial(),[page,setPage]=useState(start.page),[pageTab,setPageTab]=useState(start.tab),[menuOpen,setMenuOpen]=useState(false),[vehicleHomeKey,setVehicleHomeKey]=useState(0)
