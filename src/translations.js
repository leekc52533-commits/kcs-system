...
const routeMessages={
  en:{
    ...
    'gpsCollection.toCollect':'GPS To Collect','gpsCollection.totalActive':'Total Active Branches','gpsCollection.official':'Official GPS','gpsCollection.pending':'Pending Approval','gpsCollection.remaining':'Remaining To Collect','gpsCollection.none':'No Branch currently requires GPS collection.','gpsCollection.notCollected':'GPS Not Collected','gpsCollection.gettingGps':'Getting GPS…','gpsCollection.findingAddress':'Finding address…','gpsCollection.state':'State','gpsCollection.city':'City','gpsCollection.street':'Street','gpsCollection.streetNumber':'Street Number','gpsCollection.postalCode':'Postal Code','gpsCollection.remark':'GPS Remark','mobile.getGpsFirst':'Get the device GPS before submitting.',
  ...
  ms:{
    ...
    'gpsCollection.toCollect':'GPS Belum Dikumpul','gpsCollection.totalActive':'Jumlah Cawangan Aktif','gpsCollection.official':'GPS Rasmi','gpsCollection.pending':'Menunggu Kelulusan','gpsCollection.remaining':'Baki untuk Dikumpul','gpsCollection.none':'Tiada Cawangan yang memerlukan pengumpulan GPS.','gpsCollection.notCollected':'GPS Belum Dikumpul','gpsCollection.gettingGps':'Mendapatkan GPS…','gpsCollection.findingAddress':'Mencari alamat…','gpsCollection.state':'Negeri','gpsCollection.city':'Bandar','gpsCollection.street':'Jalan','gpsCollection.streetNumber':'Nombor Jalan','gpsCollection.postalCode':'Poskod','gpsCollection.remark':'Catatan GPS','mobile.getGpsFirst':'Dapatkan GPS peranti sebelum menghantar.',
  ...
  zh:{
    ...
    'gpsCollection.toCollect':'待采集GPS','gpsCollection.totalActive':'Active Branch总数','gpsCollection.official':'正式GPS','gpsCollection.pending':'等待批准','gpsCollection.remaining':'剩余待采集','gpsCollection.none':'目前没有需要采集GPS的Branch。','gpsCollection.notCollected':'GPS尚未采集','gpsCollection.gettingGps':'正在获取GPS…','gpsCollection.findingAddress':'正在查找地址…','gpsCollection.state':'State','gpsCollection.city':'City','gpsCollection.street':'Street','gpsCollection.streetNumber':'Street Number','gpsCollection.postalCode':'Postal Code','gpsCollection.remark':'GPS备注','mobile.getGpsFirst':'请先取得设备GPS再提交。',
