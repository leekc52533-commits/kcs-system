...
Object.assign(messages.en,{"sales.title": "Sales", "sales.add": "＋ Record Sale", "sales.from": "From Date", "sales.to": "To Date", "sales.export": "Download Excel with Settlements", "sales.blank": "Blank", "sales.photo": "Settlement photo", "sales.view": "View photo", "sales.empty": "No sales found.", "sales.select": "Select", "sales.settlementDate": "Settlement date", "sales.deliveryDate": "Delivery date", "sales.billNumber": "Settlement number", "sales.buyerName": "Factory / Buyer", "sales.vehiclePlate": "Vehicle", "sales.slipNumber": "Weighbridge slip number", "sales.description": "Material", "sales.weightKg": "Settlement weight (kg)", "sales.unitPrice": "Unit price (RM/kg)", "sales.amount": "Line amount (RM)", "sales.total": "Settlement total (RM)", "sales.remarks": "Remarks", "sales.createdBy": "Entered by", "sales.rounding": "Rounding adjustment (RM)", "sales.line": "Item", "sales.remove": "Remove item", "sales.addLine": "＋ Add item", "sales.calculated": "Calculated total", "sales.mismatch": "— Does not match settlement total", "sales.confirm": "I checked the photo, dates, vehicle, slip numbers, weights, prices and total.", "sales.cancel": "Cancel", "sales.save": "Save", "sales.retry": "Read photo again", "sales.reviewHelp": "Check every line against the photo. Missing or unclear values need your correction. The unit price may differ by line; this does not confirm payment received.", "sales.ocr.reading": "Reading settlement…", "sales.ocr.review": "Recognized draft — check all fields before saving.", "sales.ocr.unreadable": "Some details could not be read. Check the photo and fill the missing fields.", "sales.ocr.unavailable": "Recognition is unavailable. You can fill the fields manually.", "sales.ocr.busy": "Recognition is busy. Please try again.", "apiError.sales_access": "Sales is restricted to office and management.", "apiError.sales_not_found": "Settlement not found.", "apiError.sales_date": "Check delivery and settlement dates.", "apiError.sales_review": "Confirm that you checked the photo.", "apiError.sales_master": "Choose an active factory and vehicle.", "apiError.sales_number": "Enter a settlement number.", "apiError.sales_lines": "Check all line fields and duplicate slip numbers.", "apiError.sales_math": "Weight × price or total does not match.", "apiError.sales_duplicate": "This factory already has this settlement number.", "apiError.sales_stale": "This record changed. Reopen it before editing.", "apiError.sales_storage": "Photo storage is unavailable."})

Object.assign(messages.ms,{"sales.title": "Jualan", "sales.add": "＋ Rekod jualan", "sales.from": "Tarikh mula", "sales.to": "Tarikh akhir", "sales.export": "Muat turun Excel dengan penyata", "sales.blank": "Kosong", "sales.photo": "Foto penyata", "sales.view": "Lihat foto", "sales.empty": "Tiada jualan dijumpai.", "sales.select": "Pilih", "sales.settlementDate": "Tarikh penyata", "sales.deliveryDate": "Tarikh penghantaran", "sales.billNumber": "Nombor penyata", "sales.buyerName": "Kilang / Pembeli", "sales.vehiclePlate": "Kenderaan", "sales.slipNumber": "Nombor tiket timbang", "sales.description": "Bahan", "sales.weightKg": "Berat penyelesaian (kg)", "sales.unitPrice": "Harga seunit (RM/kg)", "sales.amount": "Amaun item (RM)", "sales.total": "Jumlah penyata (RM)", "sales.remarks": "Catatan", "sales.createdBy": "Dimasukkan oleh", "sales.rounding": "Pelarasan pembundaran (RM)", "sales.line": "Item", "sales.remove": "Buang item", "sales.addLine": "＋ Tambah item", "sales.calculated": "Jumlah dikira", "sales.mismatch": "— Tidak sepadan dengan jumlah penyata", "sales.confirm": "Saya telah menyemak foto, tarikh, kenderaan, nombor tiket, berat, harga dan jumlah.", "sales.cancel": "Batal", "sales.save": "Simpan", "sales.retry": "Baca foto semula", "sales.reviewHelp": "Semak setiap item dengan foto. Betulkan nilai yang tiada atau tidak jelas. Harga setiap item boleh berbeza; ini bukan pengesahan penerimaan bayaran.", "sales.ocr.reading": "Sedang membaca penyata…", "sales.ocr.review": "Draf dikenal pasti — semak semua medan sebelum menyimpan.", "sales.ocr.unreadable": "Sesetengah butiran tidak dapat dibaca. Semak foto dan isi medan yang tiada.", "sales.ocr.unavailable": "Pengecaman tidak tersedia. Anda boleh mengisi secara manual.", "sales.ocr.busy": "Pengecaman sibuk. Cuba lagi.", "apiError.sales_access": "Jualan terhad kepada pejabat dan pengurusan.", "apiError.sales_not_found": "Penyata tidak dijumpai.", "apiError.sales_date": "Semak tarikh penghantaran dan penyata.", "apiError.sales_review": "Sahkan foto telah disemak.", "apiError.sales_master": "Pilih kilang dan kenderaan aktif.", "apiError.sales_number": "Isi nombor penyata.", "apiError.sales_lines": "Semak semua item dan nombor tiket berulang.", "apiError.sales_math": "Berat × harga atau jumlah tidak sepadan.", "apiError.sales_duplicate": "Kilang ini sudah mempunyai nombor penyata ini.", "apiError.sales_stale": "Rekod telah berubah. Buka semula sebelum mengedit.", "apiError.sales_storage": "Storan foto tidak tersedia."})
