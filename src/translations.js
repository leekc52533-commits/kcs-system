...
export const messages = {
  en: {
    ...
    'mobile.notPublished':'Today’s route has not been published.','mobile.notApproved':'There is no approved route for today.','mobile.noVehicleAssigned':'No vehicle has been assigned to you today.','mobile.routeStatus':'Route status','mobile.approved':'Approved','mobile.totalStops':'Total stops','mobile.completed':'Completed','mobile.pending':'Pending','mobile.stops':'stops','mobile.notSet':'Not set','mobile.area':'Area','mobile.timeRestriction':'Time restriction','mobile.estimatedWeight':'Estimated weight','mobile.gpsStatus':'GPS','mobile.openMap':'Open in map',
  ...
  ms: {
    ...
    'mobile.notPublished':'Laluan hari ini belum diterbitkan.','mobile.notApproved':'Tiada laluan yang diluluskan untuk hari ini.','mobile.noVehicleAssigned':'Tiada kenderaan diberikan kepada anda hari ini.','mobile.routeStatus':'Status laluan','mobile.approved':'Diluluskan','mobile.totalStops':'Jumlah hentian','mobile.completed':'Selesai','mobile.pending':'Belum selesai','mobile.stops':'hentian','mobile.notSet':'Belum ditetapkan','mobile.area':'Area','mobile.timeRestriction':'Had masa','mobile.estimatedWeight':'Anggaran berat','mobile.gpsStatus':'GPS','mobile.openMap':'Buka dalam peta',
  ...
  zh: {
    ...
    'mobile.notPublished':'今天尚未发布路线。','mobile.notApproved':'今天没有已批准路线。','mobile.noVehicleAssigned':'今天尚未分配车辆。','mobile.routeStatus':'路线状态','mobile.approved':'已批准','mobile.totalStops':'总停靠点','mobile.completed':'已完成','mobile.pending':'待处理','mobile.stops':'个停靠点','mobile.notSet':'未设定','mobile.area':'区域','mobile.timeRestriction':'时间限制','mobile.estimatedWeight':'预计重量','mobile.gpsStatus':'GPS','mobile.openMap':'在地图打开',
