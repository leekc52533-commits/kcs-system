...
Object.assign(messages.en,{"expenseDetail.title": "Receipt details", "expenseDetail.required": "Vehicle expenses require vehicle, odometer, invoice number and merchant name. TIN and remarks are optional.", "expenseDetail.optional": "For Other expenses these details and the additional description are optional. Amount and receipt photo are still required.", "expenseDetail.vehicle": "Vehicle", "expenseDetail.selectVehicle": "Select vehicle", "expenseDetail.meter": "Odometer (km)", "expenseDetail.invoice": "Invoice / Reference Number", "expenseDetail.company": "Company Name", "expenseDetail.tin": "TIN Number", "expenseDetail.remarks": "Remarks", "expenseDetail.read": "Read receipt and fill blank fields", "expenseDetail.reading": "Reading receipt…", "expenseDetail.review": "Recognized values filled into blank fields only. Check every value before saving; enter unread details manually.", "expenseDetail.unreadable": "The receipt could not be read reliably. Keep the photo and enter the details manually.", "expenseDetail.unavailable": "Receipt recognition is unavailable on this server. You can still enter details and save the photo.", "expenseDetail.busy": "Another receipt is being read. Please try again shortly.", "apiError.expense_details_invalid": "Vehicle expenses require an active vehicle, valid odometer, invoice number and merchant name. Check the field lengths and values."})

Object.assign(messages.ms,{"expenseDetail.title": "Butiran resit", "expenseDetail.required": "Perbelanjaan kenderaan memerlukan kenderaan, bacaan meter, nombor invois dan nama peniaga. TIN dan catatan adalah pilihan.", "expenseDetail.optional": "Untuk Lain-lain, butiran ini dan penerangan tambahan adalah pilihan. Amaun dan gambar resit masih wajib.", "expenseDetail.vehicle": "Kenderaan", "expenseDetail.selectVehicle": "Pilih kenderaan", "expenseDetail.meter": "Bacaan meter (km)", "expenseDetail.invoice": "Nombor invois / rujukan", "expenseDetail.company": "Nama syarikat", "expenseDetail.tin": "Nombor TIN", "expenseDetail.remarks": "Catatan", "expenseDetail.read": "Baca resit dan isi medan kosong", "expenseDetail.reading": "Membaca resit…", "expenseDetail.review": "Nilai dikenal pasti hanya diisi ke medan kosong. Semak semua nilai sebelum menyimpan; isi butiran lain secara manual.", "expenseDetail.unreadable": "Resit tidak dapat dibaca dengan pasti. Simpan gambar dan isi butiran secara manual.", "expenseDetail.unavailable": "Pengecaman resit tidak tersedia pada pelayan ini. Anda masih boleh mengisi butiran dan menyimpan gambar.", "expenseDetail.busy": "Resit lain sedang dibaca. Sila cuba sebentar lagi.", "apiError.expense_details_invalid": "Perbelanjaan kenderaan memerlukan kenderaan aktif, bacaan meter sah, nombor invois dan nama peniaga. Semak panjang dan nilai medan."})

Object.assign(messages.zh,{"expenseDetail.title": "单据资料", "expenseDetail.required": "车辆费用必须填写车辆、公里数、发票号码和商家名称，TIN及备注选填。", "expenseDetail.optional": "选择其他费用时，这些资料及其他说明可留空；金额和单据照片仍必填。", "expenseDetail.vehicle": "车辆", "expenseDetail.selectVehicle": "请选择车辆", "expenseDetail.meter": "公里数（km）", "expenseDetail.invoice": "发票／参考号码", "expenseDetail.company": "商家公司名称", "expenseDetail.tin": "TIN税务编号", "expenseDetail.remarks": "备注", "expenseDetail.read": "识别单据并填入空白栏位", "expenseDetail.reading": "正在识别单据…", "expenseDetail.review": "已将识别结果填入空白栏位。请逐项核对后再保存，未识别的资料请手动填写。", "expenseDetail.unreadable": "无法可靠识别这张单据，照片已保留，请手动填写资料。", "expenseDetail.unavailable": "服务器暂时无法识别单据，仍可手动填写并保存照片。", "expenseDetail.busy": "系统正在识别另一张单据，请稍后再试。", "apiError.expense_details_invalid": "车辆费用必须填写有效车辆、公里数、发票号码和商家名称；请检查各栏位内容与长度。"})
