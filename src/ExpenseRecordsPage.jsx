...
export function FilterHeader({label,value,options,onChange,sortDirection,onSort,open,onOpen,onClose,search,onSearch,searchLabel="Search all expense records",searchPlaceholder="Employee, description or reference"}){
