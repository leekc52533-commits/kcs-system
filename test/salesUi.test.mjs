...
test('buyer-specific sale products suggest matching prices and allow manual override',async()=>{
 const root=createRoot(document.getElementById('root'))
 const initial={id:1,buyerId:1,vehicleId:1,billNumber:'CP1',settlementDate:'2026-09-10',total:'10.00',rounding:'0.00',lines:[{deliveryDate:'2026-09-09',slipNumber:'TN1',description:'OCC',weightKg:'20',unitPrice:'0.50',amount:'10.00'}]}
 const masters={buyers:[{id:1,name:'Factory'}],vehicles:[{id:1,plate:'QTY5028'}],salePrices:[{buyerId:1,description:'MIX PAPER',unitPrice:'0.25'},{buyerId:1,description:'MIX PAPER',unitPrice:'0.30'},{buyerId:2,description:'MIX PAPER',unitPrice:'0.90'}]}
 ...
 assert.equal(document.querySelectorAll('fieldset input')[4].value,'0.25')
 assert.equal(document.querySelectorAll('fieldset input')[5].value,'5.00')
