...
[[ "$SCHEMA" = 66 ]]
STAGE="$(mktemp -d /tmp/kcs-cash-bill-proof-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-cash-bill-proof-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-cash-bill-proof-${STAMP}.tar.gz"
