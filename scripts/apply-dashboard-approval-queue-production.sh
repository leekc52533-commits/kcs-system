...
BACKUP="/var/lib/kcs/data/backups/kcs-dispatch-pre-dashboard-approvals-${STAMP}.sqlite"
...
echo NEEDS_ACTION_PINNED_TOP=true
echo EMPLOYEE_APPROVAL_QUEUE=true
echo APPROVAL_AUTO_REFRESH_SECONDS=5
echo DIRECT_APPROVE_REJECT=true
