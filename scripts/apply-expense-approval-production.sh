...
[[ "$SCHEMA" = 67 || "$SCHEMA" = 68 ]]
STAGE="$(mktemp -d /tmp/kcs-expense-approval-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-expense-approval-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-expense-approval-${STAMP}.tar.gz"
