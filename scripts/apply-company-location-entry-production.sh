...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-company-location-entry-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-company-location-entry-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-company-location-entry-${STAMP}.tar.gz"
