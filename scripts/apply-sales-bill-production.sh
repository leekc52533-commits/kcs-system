...
STAGE="$(mktemp -d "$APP/.sales-bill-build-XXXXXX")"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-sales-bill-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-sales-bill-${STAMP}.tar.gz"
