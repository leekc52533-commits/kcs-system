...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-daily-report-reason-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-daily-report-reason-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-daily-report-reason-${STAMP}.tar.gz"
