...
[[ "$SCHEMA" = 66 ]]
STAGE="$(mktemp -d /tmp/kcs-compact-navigation-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-compact-navigation-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-compact-navigation-${STAMP}.tar.gz"
