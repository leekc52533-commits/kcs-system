...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-branch-review-format-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-branch-review-format-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-branch-review-format-${STAMP}.tar.gz"
