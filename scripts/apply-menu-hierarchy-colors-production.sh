...
[[ "$SCHEMA" = 66 ]]
STAGE="$(mktemp -d /tmp/kcs-menu-hierarchy-colors-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-menu-hierarchy-colors-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-menu-hierarchy-colors-${STAMP}.tar.gz"
