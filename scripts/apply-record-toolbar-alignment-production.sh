...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-record-toolbar-alignment-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-record-toolbar-alignment-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-record-toolbar-alignment-${STAMP}.tar.gz"
