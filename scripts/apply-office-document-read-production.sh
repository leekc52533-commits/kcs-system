...
[[ "$SCHEMA" = 66 ]]
STAGE="$(mktemp -d /tmp/kcs-office-document-read-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-office-document-read-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-office-document-read-${STAMP}.tar.gz"
