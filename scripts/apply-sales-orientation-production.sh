...
STAGE="$(mktemp -d "$APP/.sales-orientation-build-XXXXXX")"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-sales-orientation-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-sales-orientation-${STAMP}.tar.gz"
