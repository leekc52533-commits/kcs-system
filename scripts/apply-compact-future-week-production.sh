...
BACKUP="/var/lib/kcs/data/backups/kcs-dispatch-pre-compact-future-week-${STAMP}.sqlite"
...
echo ROUTE_DATE_UNDER_PLATE=true
echo FUTURE_WEEK_ONE_DAY_AT_A_TIME=true
echo FUTURE_WEEK_DATE_BUTTONS_PINNED=true
echo VEHICLE_ACTIONS_COMPACT_INLINE=true
