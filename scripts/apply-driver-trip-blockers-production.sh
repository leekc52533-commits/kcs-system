...
[[ "$SCHEMA" = 69 ]]
STAGE="$(mktemp -d /tmp/kcs-driver-trip-blockers-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-driver-trip-blockers-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-driver-trip-blockers-${STAMP}.tar.gz"
