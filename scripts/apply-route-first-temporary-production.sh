...
BACKUP="/var/lib/kcs/data/backups/kcs-dispatch-pre-route-first-temporary-${STAMP}.sqlite"
...
echo TEMPORARY_CUSTOMERS_ROUTE_FIRST=true
echo DIRECT_TEMPORARY_VEHICLE_ASSIGNMENT_REMOVED=true
echo ROUTE_VEHICLE_FOLLOW_THROUGH=true
echo DROPDOWN_OUTSIDE_CLICK_CLOSE=true
