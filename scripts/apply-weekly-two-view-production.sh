...
BACKUP="/var/lib/kcs/data/backups/kcs-dispatch-pre-weekly-two-view-${STAMP}.sqlite"
...
echo WEEKLY_ENTRY_TWO_VIEWS=true
echo OLD_DATE_SHORTCUTS_REMOVED=true
echo DISPATCH_DAY_TABS=true
echo ROUTE_SEVEN_DAY_VIEW=true
echo APPROVED_DAY_COLOR=true
echo MANUAL_ADJUSTMENT_PANEL_REMOVED=true
echo ROUTE_EDITING_PRESERVED=true
