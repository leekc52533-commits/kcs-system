...
test "$SCHEMA" = 58
STAGE="$(mktemp -d "$APP/.date-review-reuse-build-XXXXXX")"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-date-review-reuse-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-date-review-reuse-${STAMP}.tar.gz"
