...
test "$SCHEMA" = 57
STAGE="$(mktemp -d "$APP/.date-review-build-XXXXXX")"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-date-review-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-date-review-${STAMP}.tar.gz"
