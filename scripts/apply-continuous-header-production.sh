...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-continuous-header-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-continuous-header-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-continuous-header-${STAMP}.tar.gz"
