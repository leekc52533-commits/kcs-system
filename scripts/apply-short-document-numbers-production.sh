...
[[ "$SCHEMA" = 68 || "$SCHEMA" = 69 ]]
STAGE="$(mktemp -d /tmp/kcs-short-document-numbers-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-short-document-numbers-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-short-document-numbers-${STAMP}.tar.gz"
