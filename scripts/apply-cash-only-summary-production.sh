...
STAGE="$(mktemp -d "$APP/.cash-only-summary-build-XXXXXX")"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-cash-only-summary-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-cash-only-summary-${STAMP}.tar.gz"
