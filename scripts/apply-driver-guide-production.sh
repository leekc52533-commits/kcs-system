...
[[ "$SCHEMA" = 65 || "$SCHEMA" = 66 ]]
STAGE="$(mktemp -d /tmp/kcs-driver-guide-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-driver-guide-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-driver-guide-${STAMP}.tar.gz"
