...
[[ "$SCHEMA" = 66 ]]
STAGE="$(mktemp -d /tmp/kcs-customer-receipt-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-customer-receipt-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-customer-receipt-${STAMP}.tar.gz"
