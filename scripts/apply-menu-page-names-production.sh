...
[[ "$SCHEMA" = 66 ]]
STAGE="$(mktemp -d /tmp/kcs-menu-page-names-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-menu-page-names-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-menu-page-names-${STAMP}.tar.gz"
