...
[[ "$SCHEMA" = 66 ]]
STAGE="$(mktemp -d /tmp/kcs-sidebar-autohide-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-sidebar-autohide-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-sidebar-autohide-${STAMP}.tar.gz"
