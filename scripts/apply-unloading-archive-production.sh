...
[[ "$SCHEMA" = 66 ]]
STAGE="$(mktemp -d /tmp/kcs-unloading-archive-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-unloading-archive-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-unloading-archive-${STAMP}.tar.gz"
