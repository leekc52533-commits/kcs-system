...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-desktop-page-format-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-desktop-page-format-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-desktop-page-format-${STAMP}.tar.gz"
