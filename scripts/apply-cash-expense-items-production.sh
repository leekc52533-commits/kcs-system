...
STAGE="$(mktemp -d "$APP/.cash-expense-items-build-XXXXXX")"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-cash-expense-items-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-cash-expense-items-${STAMP}.tar.gz"
