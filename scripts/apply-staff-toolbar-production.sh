...
BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-staff-toolbar-${STAMP}.tar.gz"
...
echo STAFF_SINGLE_TOOLBAR=ready
echo STAFF_SINGLE_ACTIVE_BUTTON=ready
echo FAMILIAR_AREA_FIELD_REMOVED=ready
