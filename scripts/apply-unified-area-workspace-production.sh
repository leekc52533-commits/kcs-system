...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-unified-area-workspace-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-unified-area-workspace-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-unified-area-workspace-${STAMP}.tar.gz"
