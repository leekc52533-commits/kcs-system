...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-unloading-heading-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-unloading-heading-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-unloading-heading-${STAMP}.tar.gz"
