...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-receipt-total-alignment-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-receipt-total-alignment-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-receipt-total-alignment-${STAMP}.tar.gz"
