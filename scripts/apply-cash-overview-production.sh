...
STAGE="$(mktemp -d "$APP/.cash-overview-build-XXXXXX")"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-cash-overview-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-cash-overview-${STAMP}.tar.gz"
