...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-customer-pricing-layout-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-customer-pricing-layout-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-customer-pricing-layout-${STAMP}.tar.gz"
