...
STAGE="$(mktemp -d "$APP/.continuous-ledger-header-build-XXXXXX")"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-continuous-ledger-header-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-continuous-ledger-header-${STAMP}.tar.gz"
