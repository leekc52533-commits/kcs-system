...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-daily-report-scroll-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-daily-report-scroll-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-daily-report-scroll-${STAMP}.tar.gz"
