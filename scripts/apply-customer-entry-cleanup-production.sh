...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-customer-entry-cleanup-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-customer-entry-cleanup-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-customer-entry-cleanup-${STAMP}.tar.gz"
