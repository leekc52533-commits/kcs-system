...
[[ "$SCHEMA" = 66 ]]
STAGE="$(mktemp -d /tmp/kcs-employee-preview-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-employee-preview-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-employee-preview-${STAMP}.tar.gz"
