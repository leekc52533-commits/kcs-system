...
BACKUP="/var/lib/kcs/data/backups/kcs-dispatch-pre-dashboard-compact-${STAMP}.sqlite"
...
echo DASHBOARD_CREATE_BUTTON_REMOVED=true
echo DASHBOARD_SUMMARY_CARDS_REMOVED=true
echo SUPERVISOR_COLLECTOR_PRESERVED=true
