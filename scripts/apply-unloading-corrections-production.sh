...
[[ "$SCHEMA" = 69 || "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-unloading-corrections-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-unloading-corrections-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-unloading-corrections-${STAMP}.tar.gz"
