...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-customer-workspace-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-customer-workspace-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-customer-workspace-${STAMP}.tar.gz"
