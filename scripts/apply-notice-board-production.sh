...
[[ "$SCHEMA" = 64 || "$SCHEMA" = 65 ]]
STAGE="$(mktemp -d /tmp/kcs-notice-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-notice-board-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-notice-board-${STAMP}.tar.gz"
