...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-branch-schedule-entry-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-branch-schedule-entry-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-branch-schedule-entry-${STAMP}.tar.gz"
