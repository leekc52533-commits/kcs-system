...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-dashboard-data-tasks-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-dashboard-data-tasks-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-dashboard-data-tasks-${STAMP}.tar.gz"
