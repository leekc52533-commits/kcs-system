...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-area-create-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-area-create-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-area-create-${STAMP}.tar.gz"
