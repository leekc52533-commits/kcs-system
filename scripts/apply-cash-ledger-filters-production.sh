...
STAGE="$(mktemp -d "$APP/.cash-ledger-filters-build-XXXXXX")"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-cash-ledger-filters-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-cash-ledger-filters-${STAMP}.tar.gz"
