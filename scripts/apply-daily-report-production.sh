...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-daily-report-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-daily-report-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-daily-report-${STAMP}.tar.gz"
