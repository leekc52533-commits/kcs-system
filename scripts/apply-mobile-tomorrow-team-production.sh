...
DRIVERS_CARRIED="$(node -e 'console.log(JSON.parse(require("fs").readFileSync(process.argv[1])).driversCarried)' "$REPAIR")"
echo "SERVICE=active"
echo "HEAD=$HEAD"
echo "SCHEMA=$SCHEMA"
...
echo "FUTURE_VEHICLE_DRIVERS_CARRIED=$DRIVERS_CARRIED"
echo "MOBILE_TOMORROW_DRIVER_CONTINUITY=true"
