...
[[ "$SCHEMA" = 66 ]]
STAGE="$(mktemp -d /tmp/kcs-proof-viewer-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-proof-viewer-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-proof-viewer-${STAMP}.tar.gz"
