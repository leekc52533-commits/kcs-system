...
STAGE="$(mktemp -d "$APP/.no-goods-proof-access-build-XXXXXX")"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-no-goods-proof-access-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-no-goods-proof-access-${STAMP}.tar.gz"
