...
BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-purchase-toolbar-${STAMP}.tar.gz"
...
echo PURCHASE_SINGLE_TOOLBAR=ready
echo PURCHASE_BOTTOM_SCROLL=ready
echo PURCHASE_DATES_INLINE=ready
echo PURCHASE_COLUMN_FILTERS=ready
echo PURCHASE_TOOLBAR_STYLE=ready
