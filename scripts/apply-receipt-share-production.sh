...
[[ "$SCHEMA" = 66 ]]
STAGE="$(mktemp -d /tmp/kcs-receipt-share-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-receipt-share-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-receipt-share-${STAMP}.tar.gz"
