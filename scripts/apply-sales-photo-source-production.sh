...
STAGE="$(mktemp -d "$APP/.sales-photo-source-build-XXXXXX")"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-sales-photo-source-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-sales-photo-source-${STAMP}.tar.gz"
...
echo SALES_ORIGINAL_JPEG=ready
echo SALES_BILL_NUMBER_OCR=ready
echo SALES_BILL_LABELS=ready
echo SALES_ORIENTATION=ready
echo SALES_RETRY_REFRESH=ready
echo SALES_FACTORY_MATCH_NOTICE=ready
