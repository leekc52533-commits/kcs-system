...
STAGE="$(mktemp -d "$APP/.daily-date-download-build-XXXXXX")"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-daily-date-download-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-daily-date-download-${STAMP}.tar.gz"
