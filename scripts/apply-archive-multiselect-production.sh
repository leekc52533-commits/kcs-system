...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-archive-multiselect-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-archive-multiselect-${STAMP}.tar.gz"
...
echo ARCHIVE_MULTISELECT=ready
echo ARCHIVE_BLANK_FILTER=ready
echo ARCHIVE_COLUMN_SORT=ready
echo ARCHIVE_EXPORT_FILTERS=ready
