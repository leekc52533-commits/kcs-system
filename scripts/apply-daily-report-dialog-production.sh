...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-daily-report-dialog-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-daily-report-dialog-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-daily-report-dialog-${STAMP}.tar.gz"
