...
[[ "$SCHEMA" = 66 ]]
STAGE="$(mktemp -d /tmp/kcs-menu-folders-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-menu-folders-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-menu-folders-${STAMP}.tar.gz"
