...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-customer-id-lock-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-customer-id-lock-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-customer-id-lock-${STAMP}.tar.gz"
