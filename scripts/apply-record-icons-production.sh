...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-record-icons-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-record-icons-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-record-icons-${STAMP}.tar.gz"
