...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-daily-report-collapse-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-daily-report-collapse-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-daily-report-collapse-${STAMP}.tar.gz"
