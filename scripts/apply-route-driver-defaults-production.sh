...
BACKUP="/var/lib/kcs/data/backups/kcs-dispatch-pre-route-driver-defaults-${STAMP}.sqlite"
...
env KCS_DB_PATH="$DB" node "$APP/scripts/repair-route-vehicle-defaults.mjs"
...
echo ROUTE_VEHICLE_DEFAULTS=true\necho VEHICLE_DRIVER_DEFAULTS=true\necho MANUAL_ASSIGNMENTS_PRESERVED=true
echo TEMPORARY_ROUTE_ASSIGNMENT_FUNCTIONAL=true
echo IN_PROGRESS_OTHER_ROUTE_DOES_NOT_BLOCK=true
echo ASSIGNMENT_ERROR_VISIBLE=true
echo ASSIGNMENT_SCROLL_PRESERVED=true
