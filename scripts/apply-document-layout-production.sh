...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-document-layout-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-document-layout-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-document-layout-${STAMP}.tar.gz"
