...
BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-expense-toolbar-${STAMP}.tar.gz"
...
echo EXPENSE_SINGLE_TOOLBAR=ready
echo EXPENSE_BOTTOM_SCROLL=ready
echo EXPENSE_DATES_INLINE=ready
echo EXPENSE_COLUMN_FILTERS=ready
echo EXPENSE_TOOLBAR_STYLE=ready
