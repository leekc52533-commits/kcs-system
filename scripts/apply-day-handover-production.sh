...
BACKUP="/var/lib/kcs/data/backups/kcs-dispatch-pre-day-handover-${STAMP}.sqlite"
...
echo TODAY_HANDOVER_ENABLED=true
 echo BILL_SNAPSHOTS_PRESERVED=true
 echo TOMORROW_UNCHANGED=true
