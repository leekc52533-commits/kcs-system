...
BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-employee-column-menu-${STAMP}.tar.gz"
...
echo EMPLOYEE_COLUMN_MENUS=ready
echo EMPLOYEE_MULTISELECT=ready
echo EMPLOYEE_BLANK_FILTER=ready
echo EMPLOYEE_COLUMN_SORT=ready
echo EMPLOYEE_SINGLE_OPEN_MENU=ready
