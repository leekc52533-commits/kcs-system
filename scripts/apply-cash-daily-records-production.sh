...
STAGE="$(mktemp -d "$APP/.cash-daily-records-build-XXXXXX")"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-cash-daily-records-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-cash-daily-records-${STAMP}.tar.gz"
