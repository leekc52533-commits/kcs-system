...
BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-employee-header-style-${STAMP}.tar.gz"
...
echo EMPLOYEE_CONTINUOUS_HEADER=ready
echo EMPLOYEE_HEADER_LABEL_WRAP=ready
