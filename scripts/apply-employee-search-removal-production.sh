...
[[ "$SCHEMA" = 70 ]]
STAGE="$(mktemp -d /tmp/kcs-employee-search-removal-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-employee-search-removal-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-employee-search-removal-${STAMP}.tar.gz"
