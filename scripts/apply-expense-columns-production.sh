...
[[ "$SCHEMA" = 68 ]]
STAGE="$(mktemp -d /tmp/kcs-expense-columns-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-expense-columns-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-expense-columns-${STAMP}.tar.gz"
