...
[[ "$SCHEMA" = 69 ]]
STAGE="$(mktemp -d /tmp/kcs-trip-exceptions-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-trip-exceptions-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-trip-exceptions-${STAMP}.tar.gz"
