...
[[ "$SCHEMA" = 66 ]]
STAGE="$(mktemp -d /tmp/kcs-my-bills-build-XXXXXX)"
...
BACKUP="/var/lib/kcs/data/backups/kcs-pre-my-bills-${STAMP}.sqlite"
FRONTEND_BACKUP="/var/lib/kcs/data/backups/kcs-ui-pre-my-bills-${STAMP}.tar.gz"
